#include "vehicle_arrival_generator.h"
#include <cmath>
void vehicle_arrival_generator::init(double t,...) {
va_list parameters;
...
double vehicle_arrival_generator::ta(double t) {
return sigma;
}
void vehicle_arrival_generator::dint(double t) {
nextVehicleId++; 
...
void vehicle_arrival_generator::dext(Event x, double t) {

}
Event vehicle_arrival_generator::lambda(double t) {
output = nextVehicleId;
return Event(&output, 0);
}
void vehicle_arrival_generator::exit() {
}
