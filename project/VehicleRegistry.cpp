...
void VehicleRegistry::init(double t,...) {
	va_list parameters;
...
double VehicleRegistry::ta(double t) {
  return sigma;
}
void VehicleRegistry::dint(double t) {
...
void VehicleRegistry::dext(Event x, double t) {
...
Event VehicleRegistry::lambda(double t) {
