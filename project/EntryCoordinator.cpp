#include "EntryCoordinator.h"
void EntryCoordinator::init(double t,...) {
va_list parameters;
...
double EntryCoordinator::ta(double t) {
return sigma;
}
void EntryCoordinator::dint(double t) {
...
void EntryCoordinator::dext(Event x, double t) {
if (x.port == 1) {
...
Event EntryCoordinator::lambda(double t) {
Event event;
